...
if(empty($name) || empty($email) || empty($tele) || empty($country) || empty($message) || empty($gtoken) || empty($action)) {
	$errorMSG = '10004';
}
...
// Construct the HTML message content to send to Admin with form details
			$email_to = 'support@kimbertoken.com';
			$email_name = 'Admin';
            $email_subject = 'KimberLite Website - Contact Page Submission';
            $email_message = "
				<html><body>
                <br><br><span style='font-family:Arial;font-size:14px'>The following message was received via the <strong>Website - Contacts Page</strong>.</span><br><br>
				...
				<tr style='background: #fff;'><td style='height:35px; width:200px;font-family:Arial;font-size:14px'><strong>Email:</strong> </td><td style='height:25px; width:400px; font-family:Tahoma;font-size:14px'>" . $email . "</td></tr>
				<tr style='background: #eee;'><td style='height:35px; width:200px;font-family:Arial;font-size:14px'><strong>Telephone:</strong> </td><td style='height:25px; width:400px; font-family:Tahoma;font-size:14px'>" . $tele . "</td></tr>
				<tr style='background: #fff;'><td style='height:35px; width:200px;font-family:Arial;font-size:14px'><strong>Country:</strong> </td><td style='height:25px; width:400px; font-family:Tahoma;font-size:14px'>" . $country . "</td></tr>
				<tr style='background: #eee;'><td style='height:35px; width:200px;font-family:Arial;font-size:14px'><strong>Message:</strong> </td><td style='height:25px; width:400px; font-family:Tahoma;font-size:14px'>" . $message . "</td></tr>
				</table>
				</body></html>
            ";
