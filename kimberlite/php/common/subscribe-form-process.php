...
if(empty($email) || empty($gtoken) || empty($action)) {
	$errorMSG = '10004';
}
...
// Construct the HTML message content
            ...
            $email_message = "
				...
				<tr style='background: #eee;'><td style='height:35px; width:200px;font-family:Arial;font-size:14px'><strong>Email Address:</strong> </td><td style='height:25px; width:400px; font-family:Tahoma;font-size:14px'>" . $email . "</td></tr></tr>
				</table>
				</body></html>
            ";
